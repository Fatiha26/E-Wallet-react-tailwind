...
const Navbar = () => {
  ...
  return (
    <>
      <nav className='z-10 flex items-center shadow-md justify-between py-0 px-8'>
        <div className='flex justify-between z-50 p-5 md:w-auto w-full'>
        <div className='flex items-center gap-1'>
        <img src={logo} alt="logo" className='w-10' /> 
        <span className='text-xl font-[cursive] font-semibold text-purple-700'>ewallet</span>
        </div>
